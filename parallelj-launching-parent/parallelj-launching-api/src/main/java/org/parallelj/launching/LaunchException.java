...
public class LaunchException extends Exception {
	...
	public LaunchException(final String formatedMessage) {
		super(formatedMessage);
		this.formatedMessage = formatedMessage;
	}

	public LaunchException(final String formatedMessage, final Exception cause) {
		super(formatedMessage, cause);
		this.formatedMessage = formatedMessage;
		this.exception = cause;
	}

	public LaunchException(Exception e) {
		super(e);
		this.exception=e;
	}
